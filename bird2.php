...
try {
    ...
    // Fetch bird food products from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'bird_food'");
    $stmt->execute();
    $birdFoods = $stmt->fetchAll();
    ...
    $birdFoods = [
        [
            ...
            "image_url" => "https://survivalgardenseeds.com/cdn/shop/products/Sunflower-Mix-01.jpg?v=1652805926&width=1214",
            "description" => "Healthy seeds rich in nutrients for all bird species.",
            "price" => 299,
            "rating" => 4.3
        ],
        [
            "id" => "BF002",
            "name" => "Canary Bird Food",
            "image_url" => "https://media.zooplus.com/bilder/5/400/52290_PLA_jrfarm_individuals_kanarien_1kg_5.jpg",
            "description" => "Premium canary mix for energy and feathers.",
            "price" => 199,
            "rating" => 4.1
        ],
        [
            "id" => "BF003",
            "name" => "Parrot Pellets",
            "image_url" => "https://images-cdn.ubuy.co.in/66f6112f0c9bd679e0303432-top-39-s-parrot-food-pellets-hookbills.jpg",
            "description" => "Balanced pellets for parrots' diet.",
            "price" => 449,
            "rating" => 4.6
        ],
        [
            "id" => "BF004",
            "name" => "Cockatiel Grain Blend",
            "image_url" => "https://m.media-amazon.com/images/I/81jI0QZY3xL.jpg",
            "description" => "Natural grains for cockatiel health and growth.",
            "price" => 349,
            "rating" => 4.4
        ],
        [
            "id" => "BF005",
            "name" => "Wild Bird Seed Pack",
            "image_url" => "https://m.media-amazon.com/images/I/71NjzYpvjFL._UF1000,1000_QL80_.jpg",
            "description" => "Great for outdoor wild bird feeding.",
            "price" => 199,
            "rating" => 4.0
        ]
    ];
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-seedling"></i> Bird Food</h2>
  ...
  <div class="row g-4">
    <?php foreach ($birdFoods as $product) : ?>
