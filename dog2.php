...
try {
    ...
    // Fetch dog leashes from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'dog_leash'");
    $stmt->execute();
    $dogLeashes = $stmt->fetchAll();
    ...
    $dogLeashes = [
        [
            ...
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7j-nOEdurkbF2_-DrzEE5DbwmZoaiXzsSAA&s",
            "description" => "High-visibility leash for night walks with reflective stitching.",
            "price" => 299,
            "rating" => 4.5
        ],
        [
            "id" => "DL002",
            "name" => "Adjustable Nylon Leash",
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTo6xtHMTpEwwR-Ym0ko_dSnaD8MMA-ZxALeQ&s",
            "description" => "Durable nylon leash with multiple length adjustment points.",
            "price" => 349,
            "rating" => 4.3
        ],
        [
            ...
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRawAmhe9ivP-NfjuYMPsZFzNa7iVcoW8cyKQ&s",
            "description" => "16ft retractable leash with one-touch brake system.",
            "price" => 599,
            "rating" => 4.7
        ],
        [
            ...
            "image_url" => "https://m.media-amazon.com/images/I/91y9oNd17pL._UF1000,1000_QL80_.jpg",
            "description" => "Comfortable padded handle prevents hand fatigue on long walks.",
            "price" => 449,
            "rating" => 4.4
        ],
        [
            "id" => "DL005",
            "name" => "Double Dog Leash",
            "image_url" => "https://www.babboecargobike.com/media/catalog/product/cache/03ac6d17faf83097f0f09bba19be53f0/m/e/media_file_HWWX_0800_4f81.jpg",
            "description" => "Walk two dogs simultaneously with this dual leash system.",
            "price" => 699,
            "rating" => 4.6
        ]
    ];
...
<head>
  <meta charset="UTF-8">
  <title>Dog Leashes - PetCare</title>
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-dog"></i> Dog Leashes</h2>
  ...
  <div class="row g-4">
    <?php foreach ($dogLeashes as $product) : ?>
