...
try {
    ...
    // Fetch pet carriers from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'pet_carrier'");
    $stmt->execute();
    ...
    $carriers = [
        [
            "id" => "PC001",
            "name" => "Ventilated Soft Carrier",
            "image_url" => "https://m.media-amazon.com/images/I/81HE0p2OwKL.jpg",
            "description" => "Foldable soft-sided carrier with mesh windows for ventilation.",
            "price" => 999,
            "rating" => 4.3
        ],
        [
            "id" => "PC002",
            "name" => "Hard Shell Pet Crate",
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTU_omMcTbZelbd5HoOOD4Uf3SKdbQpzuKQFUcHjOSCKG6YNwkF7jY7tq9x4PALlyoy5PE&usqp=CAU",
            "description" => "Sturdy design for air and car travel with secure locking.",
            "price" => 1299,
            "rating" => 4.5
        ],
        [
            ...
            "image_url" => "https://www.petzlifeworld.in/cdn/shop/files/71tWcAzcJ8L._SX679.jpg?v=1719579773&width=1445",
            "description" => "Hands-free pet carrying backpack with bubble window.",
            "price" => 1799,
            "rating" => 4.7
        ],
        [
            "id" => "PC004",
            "name" => "Sling Shoulder Carrier",
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSugXxazj7tliNAf-q5MiO_OVyLzEYGtF9XlQ&s",
            "description" => "Perfect for small dogs or cats with adjustable strap.",
            "price" => 899,
            "rating" => 4.2
        ],
        [
            "id" => "PC005",
            "name" => "Transparent Capsule Carrier",
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXPsfo3p0P2PysTnqtceMeYDD6NZGXR5v0OA&s",
            "description" => "Modern design with breathable vents and 360° visibility.",
            "price" => 1399,
            "rating" => 4.6
        ]
    ];
...
<head>
  <meta charset="UTF-8">
  <title>Pet Carriers - PetCare</title>
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-briefcase"></i> Pet Carriers</h2>
  ...
  <div class="row g-4">
    <?php foreach ($carriers as $product) : ?>
