...
try {
    ...
    // Fetch bird medicines from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'bird_medicine'");
    $stmt->execute();
    $birdMedicines = $stmt->fetchAll();
    ...
    $birdMedicines = [
        [
            "id" => "BM001",
            "name" => "Himalaya Immunol Drops",
            "image_url" => "https://patmypets.com/wp-content/uploads/2021/08/Digiton.png",
            "description" => "Improves immunity and overall health of birds.",
            "price" => 165,
            "rating" => 4.5
        ],
        [
            "id" => "BM002",
            "name" => "Beaphar Multivitamin Drops",
            "image_url" => "https://content.jdmagicbox.com/quickquotes/images_main/delicious-chocolate-multivitamin-drop-gummies-802279024-ixv1u4w2.jpg",
            "description" => "Promotes healthy feathers and vitality in birds.",
            "price" => 280,
            "rating" => 4.3
        ],
        [
            "id" => "BM003",
            "name" => "Vetoquinol Nutri Drops",
            "image_url" => "https://m.media-amazon.com/images/I/51QTSvdYw-L._UF1000,1000_QL80_.jpg",
            "description" => "Daily vitamin supplement for pet birds.",
            "price" => 220,
            "rating" => 4.2
        ],
        [
            "id" => "BM004",
            "name" => "Avian Calcium Supplement",
            "image_url" => "https://m.media-amazon.com/images/I/61qj+Zh4NJL._AC_UF1000,1000_QL80_.jpg",
            "description" => "Essential calcium support for egg-laying birds.",
            "price" => 350,
            "rating" => 4.7
        ],
        [
            "id" => "BM005",
            "name" => "PetCare Vita-Drops",
            "image_url" => "https://m.media-amazon.com/images/I/51QTSvdYw-L._UF1000,1000_QL80_.jpg",
            "description" => "Complete multivitamin formula for all bird species.",
            "price" => 249,
            "rating" => 4.4
        ]
    ];
...
<head>
  <meta charset="UTF-8">
  <title>Bird Medicines - PetCare</title>
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-pills medicine-icon"></i> Bird Medicines</h2>
  ...
  <div class="row g-4">
    <?php foreach ($birdMedicines as $product) : ?>
