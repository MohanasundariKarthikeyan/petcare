...
try {
    ...
    // Fetch pet shampoos from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'pet_shampoo'");
    $stmt->execute();
    $shampoos = $stmt->fetchAll();
    ...
    $shampoos = [
        [
            "id" => "PS001",
            "name" => "Himalaya Erina Shampoo",
            "image_url" => "https://himalayawellness.in/cdn/shop/products/Erina-EP-Shampoo-200ml.jpg?v=1657874236",
            "description" => "Removes dirt and keeps coat shiny with natural ingredients.",
            "price" => 220,
            "rating" => 4.2
        ],
        [
            "id" => "PS002",
            "name" => "Papa Pawsome Shine O Fur Shampoo",
            "image_url" => "https://mypetz.co.in/wp-content/uploads/2024/01/1_8903564514872.jpg",
            "description" => "Gentle shampoo for shiny fur and healthy skin with aloe vera.",
            "price" => 289,
            "rating" => 4.5
        ],
        [
            "id" => "PS003",
            "name" => "Captain Zack Tick Repellent",
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTu4wRKClvL3YYczOL3o4ghmG5FpLwNn1Jl2LUBHLQrZfwS2S--_ds1lgj2-WhLcv-zIQw&usqp=CAU",
            "description" => "Repels ticks and fleas effectively with natural oils.",
            "price" => 349,
            "rating" => 4.3
        ],
        [
            ...
            "image_url" => "https://mlo1wbhvgmgt.i.optimole.com/w:auto/h:auto/q:mauto/f:best/https://pethero.co.za/wp-content/uploads/2024/05/Quick-Fix-Dry-Clean-Spray.jpg",
            "description" => "No-rinse shampoo for quick cleaning between baths.",
            "price" => 599,
            "rating" => 4.1
        ],
        [
            "id" => "PS005",
            "name" => "Bio-Groom Protein Shampoo",
            "image_url" => "https://m.media-amazon.com/images/I/71914rxFoML.jpg",
            "description" => "Enriched with protein and mild on sensitive skin.",
            "price" => 399,
            "rating" => 4.4
        ]
    ];
...
<head>
  <meta charset="UTF-8">
  <title>Pet Shampoos - PetCare</title>
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-bath"></i> Pet Shampoos</h2>
  ...
  <div class="row g-4">
    <?php foreach ($shampoos as $product) : ?>
