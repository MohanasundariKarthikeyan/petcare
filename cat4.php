...
try {
    ...
    // Fetch cat food products from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'cat_food'");
    $stmt->execute();
    $catFoods = $stmt->fetchAll();
    ...
    $catFoods = [
        [
            ...
            "image_url" => "https://www.whiskas.in/cdn-cgi/image/format=auto,q=90/sites/g/files/fnmzdf7971/files/2022-09/19310022715102-product-image-1.png",
            "description" => "Delicious tuna recipe for adult cats with essential nutrients.",
            "price" => 449.00,
            "rating" => 4.5
        ],
        [
            "id" => "CF002",
            "name" => "Me-O Mackerel",
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHezK_O6Mp5GqVUjLbAS79NI5NYWtSMfm8tw&s",
            "description" => "Mackerel flavor dry cat food rich in protein.",
            "price" => 399.00,
            "rating" => 4.2
        ],
        [
            ...
            "image_url" => "https://www.pets-lifestyle.com/cdn/shop/files/RoyalCaninindoor7_DryFoodCat.png?v=1714824542",
            "description" => "Premium food specially formulated for indoor cats.",
            "price" => 1299.00,
            "rating" => 4.8
        ],
        [
            "id" => "CF004",
            "name" => "Purepet Ocean Fish",
            "image_url" => "https://www.pets-lifestyle.com/cdn/shop/files/20kg.png?v=1712307175",
            "description" => "Rich in protein and essential fats for healthy coat.",
            "price" => 749.00,
            "rating" => 4.0
        ],
        [
            ...
            "image_url" => "https://www.sheba.in/cdn-cgi/image/format=auto,q=90/sites/g/files/fnmzdf2656/files/2022-08/18853301004371-product-image-1.png",
            "description" => "Wet food with tender chicken pieces in delicious gravy.",
            "price" => 120.00,
            "rating" => 4.3
        ]
    ];
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-cat"></i> Cat Food</h2>
  ...
  <div class="row g-4">
    <?php foreach ($catFoods as $product) : ?>
