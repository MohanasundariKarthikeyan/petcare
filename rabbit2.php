...
try {
    ...
    // Fetch rabbit food from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'rabbit_food'");
    $stmt->execute();
    $rabbitFoods = $stmt->fetchAll();
    ...
    $rabbitFoods = [
        [
            "id" => "RF001",
            "name" => "Bunny Bites Pellets",
            "image_url" => "https://images.onlinepets.com/product-images/catalog/BHI52ywKoPAc8E57UpT1OfPBAKiRlN-metaQnVubnktTmF0dXJlLVJhYmJpdERyZWFtLUJhc2ljLU5pZXV3ZS12ZXJwYWtraW5nLmpwZw==-.jpg",
            "description" => "High-fiber food for healthy rabbit digestion and gut health.",
            "price" => 399,
            "rating" => 4.5
        ],
        [
            "id" => "RF002",
            "name" => "Premium Rabbit Diet",
            "image_url" => "https://www.petloverscentre.com.my/Admin/Public/Getimage.ashx?width=300&height=300&compression=60&Crop=5&image=/Files/Images/Ecom/Products/67719.jpg",
            "description" => "Veterinarian-recommended blend with essential nutrients.",
            "price" => 599,
            "rating" => 4.7
        ],
        [
            "id" => "RF003",
            "name" => "Natural Veggie Mix",
            "image_url" => "https://cdn.webshopapp.com/shops/36856/files/466345384/bunny-nature-rabbitdream-vegetables-rabbit-food.jpg",
            "description" => "Enriched with vegetables, herbs and vitamins for rabbits.",
            "price" => 499,
            "rating" => 4.3
        ],
        [
            "id" => "RF004",
            "name" => "Crunchy Carrot Nuggets",
            "image_url" => "https://digitalcontent.api.tesco.com/v2/media/ghs/0f98fcdf-e7d3-4c04-a20f-11f198804f44/1b80c38d-31a4-4471-ac0c-00485c76726a_461062219.jpeg?h=960&w=960",
            "description" => "Tasty carrot pellets packed with energy and fiber.",
            "price" => 349,
            "rating" => 4.2
        ],
        [
            "id" => "RF005",
            "name" => "Healthy Herb Formula",
            "image_url" => "https://www.thehayexperts.co.uk/cdn/shop/files/mgplvmirxbi.jpg?v=1741708534",
            "description" => "Special blend of essential herbs and minerals for rabbits.",
            "price" => 449,
            "rating" => 4.6
        ]
    ];
...
<head>
  <meta charset="UTF-8">
  <title>Rabbit Food - PetCare</title>
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-carrot"></i> Rabbit Food</h2>
  ...
  <div class="row g-4">
    <?php foreach ($rabbitFoods as $product) : ?>
