...
try {
    ...
    // Fetch cat toys from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'cat_toy'");
    $stmt->execute();
    $catToys = $stmt->fetchAll();
    ...
    $catToys = [
        [
            ...
            "image_url" => "https://zoozle.in/_next/image?url=https%3A%2F%2Fcdn.zoozle.in%2Fv3%2Fecom%2Fproduct%2F9374BA43B19C44D9BE7AFC4722046293.webp&w=1080&q=75",
            "description" => "Stimulates your cat's natural instincts with colorful feathers.",
            "price" => 299,
            "rating" => 4.3
        ],
        [
            ...
            "image_url" => "https://m.media-amazon.com/images/I/71Fg39JsbSL._UF1000,1000_QL80_.jpg",
            "description" => "Soft and filled with fresh catnip for hours of fun.",
            "price" => 199,
            "rating" => 4.1
        ],
        [
            "id" => "CT003",
            "name" => "Rolling Ball Track Toy",
            "image_url" => "https://m.media-amazon.com/images/I/31D8kkhFdGL.jpg_BO30,255,255,255_UF900,850_SR1910,1000,0,C_QL100_.jpg",
            "description" => "Encourages active play and exercise with rolling balls.",
            "price" => 499,
            "rating" => 4.6
        ],
        [
            ...
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsH_08MITrTFk-AfgbiyFqjdljBNbHsaPi4Q&s",
            "description" => "Great for interactive playtime with a red laser dot.",
            "price" => 349,
            "rating" => 4.4
        ],
        [
            "id" => "CT005",
            "name" => "Spring Teaser Toy Set",
            "image_url" => "https://m.media-amazon.com/images/I/811VnRGVgtL._UF1000,1000_QL80_.jpg",
            "description" => "Set of colorful bouncy toys that cats love to bat around.",
            "price" => 249,
            "rating" => 4.2
        ]
    ];
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-cat"></i> Cat Toys</h2>
