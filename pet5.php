...
try {
    ...
    // Fetch water fountains from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'water_fountain'");
    $stmt->execute();
    $waterFountains = $stmt->fetchAll();
    ...
    $waterFountains = [
        [
            ...
            "image_url" => "https://m.media-amazon.com/images/I/81McFw1x1mL._UF350,350_QL80_.jpg",
            "description" => "2L capacity, ideal for continuous hydration with quiet operation.",
            "price" => 1299,
            "rating" => 4.5
        ],
        [
            "id" => "WF002",
            "name" => "Stainless Steel Fountain",
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1xr0uDQ9G5LicJE4o5kquqQ4ZKO6RnJC8BA&s",
            "description" => "Durable and hygienic stainless steel with quiet pump.",
            "price" => 1999,
            "rating" => 4.7
        ],
        [
            "id" => "WF003",
            "name" => "LED Water Dispenser",
            "image_url" => "https://m.media-amazon.com/images/I/81c-ZBTTaXL.jpg",
            "description" => "Nightlight with water level indicator for easy monitoring.",
            "price" => 1499,
            "rating" => 4.3
        ],
        [
            "id" => "WF004",
            "name" => "Flower Design Fountain",
            "image_url" => "https://m.media-amazon.com/images/I/61A3TfyzS2L.jpg",
            "description" => "Attractive flower design that pets love to drink from.",
            "price" => 1399,
            "rating" => 4.2
        ],
        [
            "id" => "WF005",
            "name" => "Filter Replacement Pack",
            "image_url" => "https://m.media-amazon.com/images/I/81OzxH97YbL.jpg",
            "description" => "5-pack filters for maintaining clean and safe water.",
            "price" => 499,
            "rating" => 4.0
        ]
    ];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    ...
    try {
        ...
        if ($existingItem) {
            ...
            $product = null;
            foreach ($waterFountains as $item) {
...
<head>
  <meta charset="UTF-8">
  <title>Pet Water Fountains - PetCare</title>
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-faucet"></i> Pet Water Fountains</h2>
  ...
  <div class="row g-4">
    <?php foreach ($waterFountains as $product) : ?>
