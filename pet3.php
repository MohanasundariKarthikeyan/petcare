...
try {
    ...
    // Fetch pet bowls from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'pet_bowl'");
    $stmt->execute();
    $petBowls = $stmt->fetchAll();
    ...
    $petBowls = [
        [
            ...
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSypV10RggolwDKSj0FYxNqGKrR8UVPPOMWGw&s",
            "description" => "Durable and rust-resistant stainless steel bowl with rubber base.",
            "price" => 249,
            "rating" => 4.5
        ],
        [
            ...
            "image_url" => "https://m.media-amazon.com/images/I/513g5gR3Q4L._UF1000,1000_QL80_.jpg",
            "description" => "Portable and perfect for travel, folds flat when not in use.",
            "price" => 199,
            "rating" => 4.2
        ],
        [
            "id" => "PB003",
            "name" => "Double Feeder Bowl",
            "image_url" => "https://m.media-amazon.com/images/I/71aKh0W221L._UF1000,1000_QL80_.jpg",
            "description" => "Dual-section bowl for food and water in one convenient unit.",
            "price" => 379,
            "rating" => 4.3
        ],
        [
            "id" => "PB004",
            "name" => "Anti-Skid Plastic Bowl",
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8Vwc4qQYbB8Bt9T3T2xpKmvAEZrUA0lxTDA&s",
            "description" => "Sturdy plastic bowl with non-slip base to prevent spills.",
            "price" => 159,
            "rating" => 3.9
        ],
        [
            "id" => "PB005",
            "name" => "Tilted Cat Feeding Bowl",
            "image_url" => "https://m.media-amazon.com/images/I/51URrenulJL.jpg",
            "description" => "Ergonomic design for easy feeding, reduces neck strain.",
            "price" => 299,
            "rating" => 4.6
        ]
    ];
...
<head>
  <meta charset="UTF-8">
  <title>Pet Food Bowls - PetCare</title>
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-utensils"></i> Pet Food Bowls</h2>
  ...
  <div class="row g-4">
    <?php foreach ($petBowls as $product) : ?>
