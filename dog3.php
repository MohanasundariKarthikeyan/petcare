...
try {
    ...
    // Fetch dog beds from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'dog_bed'");
    $stmt->execute();
    $dogBeds = $stmt->fetchAll();
    ...
    $dogBeds = [
        [
            ...
            "image_url" => "https://www.petkonnect.in/cdn/shop/products/PK2022yAzZxnseGA.jpg?v=1735907870&width=1445",
            "description" => "Supportive memory foam bed for joint relief and comfort.",
            "price" => 999,
            "rating" => 4.7
        ],
        [
            "id" => "DB002",
            "name" => "Plush Donut Cuddler",
            "image_url" => "https://static.athome.com/images/w_1200,h_1200,c_pad,f_auto,fl_lossy,q_auto/v1728649822/p/124410914/36x36-pv-plush-donut-cuddler-with-liner.jpg",
            "description" => "Calming bed with soft faux fur for ultimate comfort.",
            "price" => 899,
            "rating" => 4.5
        ],
        [
            "id" => "DB003",
            "name" => "Waterproof Dog Mattress",
            "image_url" => "https://5.imimg.com/data5/SELLER/Default/2023/10/351597344/PW/MR/JF/159/waterproof-dog-bed.png",
            "description" => "Easy to clean waterproof bed perfect for crates.",
            "price" => 749,
            "rating" => 4.3
        ],
        [
            "id" => "DB004",
            "name" => "Heated Dog Bed",
            "image_url" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ48Td9Y6_t4gDEXK4mmEhqE6sN4mrd2OeibQ&s",
            "description" => "Keeps your pet warm during cold winter months.",
            "price" => 1499,
            "rating" => 4.8
        ],
        [
            ...
            "image_url" => "https://i.etsystatic.com/9295234/r/il/0c192a/5391009525/il_570xN.5391009525_erfu.jpg",
            "description" => "Foldable and lightweight bed for travel convenience.",
            "price" => 649,
            "rating" => 4.2
        ]
    ];
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-dog"></i> Dog Beds</h2>
  ...
  <div class="row g-4">
    <?php foreach ($dogBeds as $product) : ?>
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card h-100">
          <img src="<?= htmlspecialchars($product['image_url'] ?? $product['image']) ?>" class="card-img-top" alt="<?= htmlspecialchars($product['name']) ?>" 
