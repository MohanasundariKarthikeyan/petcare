...
try {
    ...
    // Fetch bird perches from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'bird_perch'");
    $stmt->execute();
    $birdPerches = $stmt->fetchAll();
    ...
    $birdPerches = [
        [
            ...
            "image_url" => "https://www.theparrotmom.com/cdn/shop/products/10.51.40.21.00.jpg?v=1628086231&width=1946",
            "description" => "Smooth wooden perch for parrots and cockatoos with natural texture.",
            "price" => 499,
            "rating" => 4.3
        ],
        [
            "id" => "BP002",
            "name" => "Rope Swing Stand",
            "image_url" => "https://m.media-amazon.com/images/I/61nKNsZXAuL.jpg",
            "description" => "Fun rope perch with hanging swing style for playful birds.",
            "price" => 399,
            "rating" => 4.1
        ],
        [
            "id" => "BP003",
            "name" => "Natural Branch Perch",
            "image_url" => "https://prevuepet.com/images/products/productaddl_670_1265_0_resized_15462_zoom.jpg",
            "description" => "Natural branch look for indoor bird cages with secure mounting.",
            "price" => 299,
            "rating" => 4.0
        ],
        [
            "id" => "BP004",
            "name" => "Adjustable Stand Perch",
            "image_url" => "https://m.media-amazon.com/images/I/51u2mMJ9PiL.jpg",
            "description" => "Height-adjustable bird training perch with sturdy base.",
            "price" => 899,
            "rating" => 4.6
        ],
        [
            "id" => "BP005",
            "name" => "Multi-Branch Platform",
            "image_url" => "https://www.theparrotmom.com/cdn/shop/products/40.20.20.00.02.jpg?v=1628086573&width=1946",
            "description" => "Platform with multiple perch branches for active birds.",
            "price" => 649,
            "rating" => 4.4
        ],
        [
            "id" => "BP006",
            "name" => "Corner Perch with Toy Hooks",
            "image_url" => "https://m.media-amazon.com/images/I/71Z0jQ5yQML._AC_UF1000,1000_QL80_.jpg",
            "description" => "Space-saving corner perch with built-in toy hooks for enrichment.",
            "price" => 549,
            "rating" => 4.2
        ],
        [
            "id" => "BP007",
            "name" => "Thermal Rock Perch",
            "image_url" => "https://m.media-amazon.com/images/I/61h3Z3g9Y2L.jpg",
            "description" => "Thermal rock perch helps regulate bird's body temperature naturally.",
            "price" => 749,
            "rating" => 4.5
        ],
        [
            "id" => "BP008",
            "name" => "Spiral Java Wood Perch",
            "image_url" => "https://m.media-amazon.com/images/I/71P4YyQeQdL.jpg",
            "description" => "Natural java wood in spiral design for foot exercise and comfort.",
            "price" => 699,
            "rating" => 4.3
        ]
    ];
...
<head>
  <meta charset="UTF-8">
  <title>Bird Perch Stands - PetCare</title>
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-dove"></i> Bird Perch Stands</h2>
  ...
  <div class="row g-4">
    <?php foreach ($birdPerches as $product) : ?>
