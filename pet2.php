...
try {
    ...
    // Fetch nail clippers from database
    $stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'nail_clipper'");
    $stmt->execute();
    $clippers = $stmt->fetchAll();
    ...
    $clippers = [
        [
            "id" => "NC001",
            "name" => "Pecute Nail Clipper",
            "image_url" => "https://m.media-amazon.com/images/I/61CjZTePfXL.jpg",
            "description" => "Professional clipper with safety guard to prevent overcutting.",
            "price" => 349,
            "rating" => 4.5
        ],
        [
            "id" => "NC002",
            "name" => "PetVogue Nail Cutter",
            "image_url" => "https://m.media-amazon.com/images/I/51XIj8cJG-L._UF1000,1000_QL80_.jpg",
            "description" => "Comfortable grip and sharp stainless steel blade.",
            "price" => 299,
            "rating" => 4.2
        ],
        [
            "id" => "NC003",
            "name" => "Furville Clipper with File",
            "image_url" => "https://m.media-amazon.com/images/I/61L44WQpqOL._AC_UF1000,1000_QL80_.jpg",
            "description" => "Complete grooming set with nail file for smooth finish.",
            "price" => 379,
            "rating" => 4.6
        ],
        [
            "id" => "NC004",
            "name" => "Vissco Professional Grooming Tool",
            "image_url" => "https://5.imimg.com/data5/SELLER/Default/2024/5/421170449/WM/TQ/UH/187514615/pet-dog-grooming-tools.jpg",
            "description" => "Ideal for medium and large dogs with quick sensor.",
            "price" => 420,
            "rating" => 4.3
        ],
        [
            "id" => "NC005",
            "name" => "Trixie Stainless Nail Scissors",
            "image_url" => "https://supertails.com/cdn/shop/files/Frame-2023-07-11T124604.865.png?v=1696625797",
            "description" => "Scissors-style clipper with precision cutting.",
            "price" => 259,
            "rating" => 4.0
        ]
    ];
...
<head>
  <meta charset="UTF-8">
  <title>Pet Nail Clippers - PetCare</title>
...
<div class="container mt-5">
  <h2 class="section-title"><i class="fas fa-cut"></i> Pet Nail Clippers</h2>
  ...
  <div class="row g-4">
    <?php foreach ($clippers as $product) : ?>
